...
models = (svm.SVC(kernel='linear', C=C),
          ...
          svm.SVC(kernel='poly', degree=4, gamma='auto', C=1e-2))
print('training...')
models = (clf.fit(X_train_scaled, np.ravel(Ytrain)) for clf in models)
f = (clf.score(X_test_scaled,Ytest) for clf in models)
score = [sc for sc in f]
...
ax.set_title('Accuracy of Four SVCs')
